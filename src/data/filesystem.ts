...
export const filesystem: Record<string, FSEntry> = {
	...
	// /boot
	'/boot/vmlinuz-linux': { type: 'file', content: [
	...
	'/boot/initramfs-linux.img': { type: 'file', content: [
		'\x1b[red]cat: /boot/initramfs-linux.img: Binary file\x1b[reset]',
	]},
	...
	'/etc/pacman.conf': { type: 'file', content: [
		'#',
		'# /etc/pacman.conf',
		'#',
		'[options]',
	...
	'/proc/loadavg': { type: 'file', content: [
	...
	'/var/log/pacman.log': { type: 'file', content: [
	...
	'/home/michel/.bashrc': { type: 'file', content: [
	...
	'/home/michel/.zshrc': { type: 'file', content: [
	...
	'/home/michel/.vimrc': { type: 'file', content: [
	...
	'/home/michel/.bash_history': { type: 'file', content: [
		'sudo rm -rf /',
	...
	'/home/michel/.gitconfig': { type: 'file', content: [
		'[user]',
		'    name = Michel',
	...
	'/home/michel/.ssh/id_rsa': { type: 'file', content: [
	...
	'/home/michel/.ssh/id_ed25519': { type: 'file', content: [
		'-----BEGIN OPENSSH PRIVATE KEY-----',
	...
	'/home/michel/.ssh/known_hosts': { type: 'file', content: [
	...
	'/home/michel/.ssh/authorized_keys': { type: 'file', content: [
	...
	'/home/michel/.aws/credentials': { type: 'file', content: [
		'[default]',
	...
	'/home/michel/.kube/config': { type: 'file', content: [
		'apiVersion: v1',
		'kind: Config',
		'clusters:',
		'- cluster:',
	...
	'/home/michel/.npmrc': { type: 'file', content: [
	...
	'/home/michel/.pgpass': { type: 'file', content: [
	...
	'/home/michel/.local/share/Trash': { type: 'file', content: [
	...
	'/home/michel/seed_phrase_DO_NOT_DELETE.txt': { type: 'file', content: [
	...
	'/home/michel/.bitcoin_wallet.dat': { type: 'file', content: [
	...
	'/home/michel/.ethereum_keystore.json': { type: 'file', content: [
		'{',
	...
	'/home/michel/wallet.json': { type: 'file', content: [
		'{',
	...
	'/home/michel/recovery.txt': { type: 'file', content: [
	...
	'/home/michel/backup_codes.txt': { type: 'file', content: [
	...
	'/home/michel/blog/README.md': { type: 'file', content: [
		'# Michel\'s Blog',
		'',
	...
	'/home/michel/blog/package.json': { type: 'file', content: [
		'{',
		'  "name": "michel-blog",',
		'  "version": "1.33.7",',
		'  "private": true,',
	...
	'/home/michel/blog/package-lock.json': { type: 'file', content: [
		'{',
		'  "name": "michel-blog",',
		'  "lockfileVersion": 3,',
		'  "packages": {',
	...
	'/home/michel/blog/tsconfig.json': { type: 'file', content: [
		'{',
		'  "compilerOptions": {',
		'    "target": "ES2020",',
	...
	'/home/michel/blog/.env': { type: 'file', content: [
	...
	'/home/michel/blog/.git/config': { type: 'file', content: [
		'[core]',
	...
	'/home/michel/blog/Dockerfile': { type: 'file', content: [
	...
	'/home/michel/blog/.dockerignore': { type: 'file', content: [
		'node_modules',
		'node_modules',
		'node_modules',
	...
	'/home/michel/blog/posts/learning-rust.md': { type: 'file', content: [
	...
	'/home/michel/blog/src/main.tsx': { type: 'file', content: [
	...
	'/home/michel/blog/public/favicon.ico': { type: 'file', content: [
	...
	'/tmp/npm-cache/README': { type: 'file', content: [
		'npm cache directory',
		'',
		'Size: 69GB',
		'Age: 3 years',
	...
	// /mnt
	'/mnt/nas': { type: 'dir' },
	'/mnt/nas/anime': { type: 'file', content: [
...
export function resolvePath(path: string, cwd: string): string {
	...
	if (path === '~' || path === '~/')
		return '/home/michel'
	if (path.startsWith('~/'))
		return normalizePath('/home/michel' + path.slice(1))
...
export function formatLsEntry(name: string, parentPath: string): string {
	...
	if (entry.type === 'dir')
		return `\x1b[cyan]${name}/\x1b[reset]`

	// Color special files
	if (name.startsWith('.'))
		return `\x1b[yellow]${name}\x1b[reset]`
	if (name.endsWith('.json') || name.endsWith('.lock'))
		return `\x1b[green]${name}\x1b[reset]`
	if (name.endsWith('.md'))
		return `\x1b[blue]${name}\x1b[reset]`
...
export function toDisplayPath(path: string): string {
	if (path === '/home/michel')
		return '~'
	if (path.startsWith('/home/michel/'))
		return '~' + path.slice('/home/michel'.length)
	return path
}
...
export const allFilePaths = Object.keys(filesystem).filter(p => filesystem[p]?.type === 'file').sort()
export const allDirPaths = Object.keys(filesystem).filter(p => filesystem[p]?.type === 'dir').sort()
